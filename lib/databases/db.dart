class WordsDB {
  ...
  final List<Map<String, dynamic>> allWords = [
    ...
    },
    {
      ...
      'adjective':'',
      'adverb':'',
      'preposition':'1. kwa maneku kaufela \n2. fakaufi ni',
      'synonym':'',
      'antonym':''
    },
    {
    ...
    },
    {
      'id':5,
      'word':'mamkin',
      'noun':'1. kambalamatende',
      'plural':'1. tumbalamatende',
      'description':'bird',
      'phrase':'',
      'verb':'',
      't_verb': false,
    ...
    },
    {
      ...
      'adjective':'',
      'adverb':'',
      'preposition':'1. mwatasi a \n2. mwatasaa',
      'synonym':'1. underneath \n2. below \n3. beneath',
      'antonym':''
    },
    {
      'id':17,
    ...
    {
      'id':19,
      'word':'untrustworthy person',
      'noun':'1. ya sa sepahali',
      'plural':'1. ya baba sepahali',
      'description':'',
      'phrase':'',
      'verb':'',
      't_verb': false,
...
//   {'id': 117, 'name': 'ebullient', 'mean': 'adj. cheerful, enthusiastic, excited'},
//   {'id': 118, 'name': 'eccentric', 'mean': 'adj. quirky or unusual'},
//   {'id': 119, 'name': 'eclectic', 'mean': 'adj. composed of a variety of styles, themes, motifs, etc.'},
//   {'id': 120, 'name': 'efficacy', 'mean': 'n. effectiveness'},
//   {'id': 121, 'name': 'elegy', 'mean': 'n. sad poem or song, often in remembrance of someone deceased'},
//   {'id': 122, 'name': 'elicit', 'mean': 'v. to provoke a response'},
//   {'id': 123, 'name': 'eloquence', 'mean': 'adj. persuasive and articulate speech'},
//   {'id': 124, 'name': 'eminent', 'mean': 'adj. well-known, respected, distinguished'},
//   {'id': 125, 'name': 'empirical', 'mean': 'adj. based on evidence'},
//   {'id': 126, 'name': 'emulate', 'mean': 'v. to imitate or attempt to equal in accomplishment'},
...
//   {'id': 130, 'name': 'entitlement', 'mean': 'n. belief that one deserves things one has not earned'},
//   {'id': 131, 'name': 'ephemeral', 'mean': 'adj. short-lived or transient'},
//   {'id': 132, 'name': 'equable', 'mean': 'adj. not given to much change or variation'},
//   {'id': 133, 'name': 'equivocate', 'mean': 'v. to use ambiguous language in order to mislead or deceive'},
...
//   {'id': 138, 'name': 'estimable', 'mean': 'adj. deserving respect, esteem, and admiration'},
//   {'id': 139, 'name': 'eulogy', 'mean': 'n. memorial speech for one who has passed, normally given at a funeral'},
//   {'id': 140, 'name': 'exacerbate', 'mean': 'v. to make worse'},
//   {'id': 141, 'name': 'exacting', 'mean': 'adj. challenging, demanding, grueling'},
//   {'id': 142, 'name': 'exculpate', 'mean': 'v. to exonerate or vindicate'},
//   {'id': 143, 'name': 'exigent', 'mean': 'adj. urgent or pressing'},
//   {'id': 144, 'name': 'exonerate', 'mean': 'v. to clear of charges of wrongdoing'},
//   {'id': 145, 'name': 'expatiate', 'mean': 'v. to elaborate on something in great detail'},
...
//   {'id': 149, 'name': 'extrapolate', 'mean': 'v. to estimate or conjecture about the future based on presently available information or facts'},
//   {'id': 150, 'name': 'facetious', 'mean': 'adj. glib or flippant'},
//   {'id': 151, 'name': 'facilitate', 'mean': 'v. to make something easier or simpler'},
//   {'id': 152, 'name': 'fallacious', 'mean': 'adj. relying on a fallacy and thus incorrect/misinformed'},
//   {'id': 153, 'name': 'fastidious', 'mean': 'adj. invested in cleanliness'},
//   {'id': 154, 'name': 'fluctuate', 'mean': 'v. to shift without apparent pattern'},
//   {'id': 155, 'name': 'foment', 'mean': 'v. to foster unrest or discontent'},
//   {'id': 156, 'name': 'forestall', 'mean': 'v. to hold off or try to prevent'},
...
//   {'id': 162, 'name': 'gauche', 'mean': 'adj. socially inept, inappropriate, or awkward'},
//   {'id': 163, 'name': 'germane', 'mean': 'adj. relevant to the matter at hand'},
//   {'id': 164, 'name': 'glib', 'mean': 'adj. talking volubly, but carelessly or insincerely'},
...
//   {'id': 170, 'name': 'hierarchical', 'mean': 'adj. arranged in rank order or hierarchy'},
//   {'id': 171, 'name': 'homogenous', 'mean': 'adj. uniform, identical'},
//   {'id': 172, 'name': 'hyperbole', 'mean': 'n. obvious exaggeration for effect'},
//   {'id': 173, 'name': 'iconoclast', 'mean': 'n. a person who attacks traditional religious and cultural institutions'},
//   {'id': 174, 'name': 'ideological', 'mean': 'adj. relating to a particular belief system or theory'},
//   {'id': 175, 'name': 'imminent', 'mean': 'adj. about to happen'},
//   {'id': 176, 'name': 'immutable', 'mean': 'adj. unchangeable'},
//   {'id': 177, 'name': 'impair', 'mean': 'v. to hinder or weaken someone or something'},
//   {'id': 178, 'name': 'impediment', 'mean': 'n. barrier, hindrance, or obstruction'},
//   {'id': 179, 'name': 'imperturbable', 'mean': 'adj. remaining calm under any circumstance'},
//   {'id': 180, 'name': 'implacable', 'mean': 'adj. relentless'},
//   {'id': 181, 'name': 'implicit', 'mean': 'adj. implied or insinuated without being directly stated'},
//   {'id': 182, 'name': 'imprudence', 'mean': 'n. bad judgment'},
//   {'id': 183, 'name': 'impudent', 'mean': 'adj. disrespectful'},
//   {'id': 184, 'name': 'inadvertent', 'mean': 'adj. by accident or unintentional'},
//   {'id': 185, 'name': 'Inchoate', 'mean': 'adj. rudimentary, in the beginning stages'},
//   {'id': 186, 'name': 'inconclusive', 'mean': 'adj. indeterminate or unresolved'},
//   {'id': 187, 'name': 'indebted', 'mean': 'adj. owing gratitude to someone or something'},
//   {'id': 188, 'name': 'indefatigable', 'mean': 'adj. cannot be made tired'},
//   {'id': 189, 'name': 'indolent', 'mean': 'adj. lazy'},
//   {'id': 190, 'name': 'infer', 'mean': 'v. to conclude from implicit evidence (as opposed to explicit facts)'},
...
//   {'id': 194, 'name': 'inscrutable', 'mean': 'adj. enigmatic, incomprehensible'},
//   {'id': 195, 'name': 'insipid', 'mean': 'adj. bland, uninspired, inane'},
//   {'id': 196, 'name': 'insular','mean': 'adj. tight-knit and isolated; uninterested in matters outside one’s immediate sphere'},
...
//   {'id': 201, 'name': 'intransigent', 'mean': 'adj. uncompromising, obstinate'},
//   {'id': 202, 'name': 'intrepid', 'mean': 'adj. bold and adventurous'},
//   {'id': 203, 'name': 'inveterate', 'mean': 'adj. ingrained, habitual'},
//   {'id': 204, 'name': 'invulnerable', 'mean': 'adj. indestructible, impervious to harm'},
...
//   {'id': 214, 'name': 'magnanimity', 'mean': 'n. generosity and nobility of spirit'},
...
//   {'id': 221, 'name': 'meticulous', 'mean': 'adj. paying close attention to detail'},
//   {'id': 222, 'name': 'misanthrope', 'mean': 'n. person who hates humanity'},
//   {'id': 223, 'name': 'mitigate', 'mean': 'v. to  improve a painful, unpleasant, or negative situation'},
...
//   {'id': 230, 'name': 'nascent', 'mean': 'adj. just beginning or in the early stages'},
//   {'id': 231, 'name': 'neglect', 'mean': 'v. to abandon or leave uncared-for'},
//   {'id': 232, 'name': 'nonplussed', 'mean': 'adj. confused and baffled'},
//   {'id': 233, 'name': 'notoriety', 'mean': 'n. fame for doing something negative or criminal'},
...
//   {'id': 237, 'name': 'obsequious', 'mean': 'adj. overly fawning and helpful in a way that is disingenuous'},
...
//   {'id': 243, 'name': 'olfactory', 'mean': 'adj. relating to smell or the sense of smell'},
//   {'id': 244, 'name': 'omniscience', 'mean': 'n. the quality or state of being all-knowing'},
//   {'id': 245, 'name': 'onerous', 'mean': 'adj. difficult or burdensome'},
//   {'id': 246, 'name': 'opaque', 'mean': 'adj. not see-through; blocking light'},
//   {'id': 247, 'name': 'opportunism', 'mean': 'n. the practice of taking advantage of opportunities as they arise without particular concern for morality or ethics'},
//   {'id': 248, 'name': 'opprobrium', 'mean': 'n. criticism or condemnation'},
//   {'id': 249, 'name': 'oscillate', 'mean': 'v. to swing back and forth between two points, poles, or positions'},
//   {'id': 250, 'name': 'ostentatious', 'mean': 'adj. overly showy in a way that is gaudy or vulgar'},
//   {'id': 251, 'name': 'outstrip', 'mean': 'v. to overtake or outrun'},
//   {'id': 252, 'name': 'overshadow', 'mean': 'v. to appear more notable than'},
//   {'id': 253, 'name': 'painstaking', 'mean': 'adj. attentive to detail, meticulous'},
//   {'id': 254, 'name': 'partial', 'mean': 'adj. incomplete'},
//   {'id': 255, 'name': 'partisan', 'mean': 'n. a devoted supporter of a group, cause, or person'},
//   {'id': 256, 'name': 'patent', 'mean': 'adj. blatant, obvious'},
//   {'id': 257, 'name': 'paucity', 'mean': 'n. scarcity, poverty'},
//   {'id': 258, 'name': 'pedantic', 'mean': 'adj. overly concerned with irrelevant detail, fussy'},
//   {'id': 259, 'name': 'pedestrian', 'mean': 'adj. boring, monotonous, run-of-the-mill'},
//   {'id': 260, 'name': 'perfidy', 'mean': 'n. treachery or deceit'},
//   {'id': 261, 'name': 'perfunctory', 'mean': 'adj. done without much effort, care, or thought'},
//   {'id': 262, 'name': 'peripheral', 'mean': 'adj. on the edge or periphery; not centrally important'},
//   {'id': 263, 'name': 'permeate', 'mean': 'v. to pervade or penetrate throughout'},
//   {'id': 264, 'name': 'perseverance', 'mean': 'n. persistence in the face of obstacles'},
//   {'id': 265, 'name': 'peruse', 'mean': 'v. to read something informally or quickly'},
//   {'id': 266, 'name': 'pervasive', 'mean': 'adj. found everywhere, widespread; often has a negative connotation'},
//   {'id': 267, 'name': 'phenomena', 'mean': 'n. things that happen'},
//   {'id': 268, 'name': 'phlegmatic', 'mean': 'adj. cool and unruffled'},
//   {'id': 269, 'name': 'pith', 'mean': 'n. the essential substance of something'},
//   {'id': 270, 'name': 'placate', 'mean': 'v. to calm, esp. an angry or upset person'},
...
//   {'id': 274, 'name': 'plethora', 'mean': 'n. a surplus or overabundance of something'},
//   {'id': 275, 'name': 'plummet', 'mean': 'v. to fall quickly and far'},
//   {'id': 276, 'name': 'polarize', 'mean': 'v. to cause a sharp division between two groups'},
//   {'id': 277, 'name': 'polemical', 'mean': 'adj. angry, hostile, harshly critical'},
...
//   {'id': 281, 'name': 'precipitate', 'mean': 'n. particulate matter formed within a solution'},
//   {'id': 282, 'name': 'precursor', 'mean': 'n. a forerunner'},
//   {'id': 283, 'name': 'prescient', 'mean': 'adj. knowing things before they happen, prophetic'},
//   {'id': 284, 'name': 'presumptuous', 'mean': 'adj. overly familiar; invades social boundaries'},
//   {'id': 285, 'name': 'prevail', 'mean': 'v. to convince or persuade'},
//   {'id': 286, 'name': 'prevaricate', 'mean': 'v. to evade or deceive without outright lying'},
...
//   {'id': 290, 'name': 'prodigious', 'mean': 'adj. enormous, immense, gigantic'},
//   {'id': 291, 'name': 'profligate', 'mean': 'adj. extravagant and wasteful, esp. in an immoral way'},
//   {'id': 292, 'name': 'proliferate', 'mean': 'v. to multiply and spread rapidly'},
//   {'id': 293, 'name': 'propitiate', 'mean': 'v. to appease someone who is angry'},
//   {'id': 294, 'name': 'propriety', 'mean': 'n. appropriateness, manners, decorum'},
//   {'id': 295, 'name': 'prospective', 'mean': 'adj. applicable to the future'},
//   {'id': 296, 'name': 'qualification', 'mean': 'n. a modifying statement'},
//   {'id': 297, 'name': 'quotidian', 'mean': 'adj. relating to the everyday or mundane'},
//   {'id': 298, 'name': 'rationalize', 'mean': 'v. to attempt to justify with reasons that are only superficially valid'},
...
//   {'id': 303, 'name': 'relevant', 'mean': 'adj. relating to the topic or issue at hand'},
//   {'id': 304, 'name': 'reproach', 'mean': 'v. to scold or express criticism'},
//   {'id': 305, 'name': 'repudiate', 'mean': 'v. to renounce or disown'},
//   {'id': 306, 'name': 'rescind', 'mean': 'v. to take back or retract (an offer or statement)'},
//   {'id': 307, 'name': 'respectively', 'mean': 'adv. in the sequential order previously given'},
//   {'id': 308, 'name': 'reticent', 'mean': 'adj. introverted or silent'},
//   {'id': 309, 'name': 'reverent', 'mean': 'adj. solemn and respectful'},
//   {'id': 310, 'name': 'rhetoric', 'mean': 'n. the art of effective communication (written or verbal)'},
//   {'id': 311, 'name': 'salubrious', 'mean': 'adj. health-promoting'},
//   {'id': 312, 'name': 'sanction', 'mean': 'n. punishments imposed for breaking a regulation'},
//   {'id': 313, 'name': 'satiate', 'mean': 'v. to completely satisfy (with respect to hunger or appetite)'},
//   {'id': 314, 'name': 'secular', 'mean': 'adj. of or relating to the world or worldly matters (as opposed to religious ones)'},
//   {'id': 315, 'name': 'sediment', 'mean': 'n. material that settles at the bottom of a body of water'},
//   {'id': 316, 'name': 'sedulous', 'mean': 'adj. dedicated and careful'},
//   {'id': 317, 'name': 'simultaneous', 'mean': 'adj. occurring at the same moment'},
...
//   {'id': 321, 'name': 'specious', 'mean': 'adj. spurious; appearing true but actually false'},
...
//   {'id': 325, 'name': 'subjective', 'mean': 'adj. open to personal interpretation; not based in objective fact'},
//   {'id': 326, 'name': 'substantiate', 'mean': 'v. to corroborate or give evidence of something'},
//   {'id': 327, 'name': 'subversive', 'mean': 'adj. meant to undercut established institutions or norms'},
//   {'id': 328, 'name': 'sufficient', 'mean': 'adj. enough for a given purpose'},
//   {'id': 329, 'name': 'superbly', 'mean': 'adv. excellently'},
//   {'id': 330, 'name': 'supine', 'mean': 'adj. laying back with the face upward (opposite position to prone)'},
//   {'id': 331, 'name': 'supplant', 'mean': 'v. to overtake or replace'},
//   {'id': 332, 'name': 'sycophant', 'mean': 'n. a fawning, insincere admirer'},
//   {'id': 333, 'name': 'synthesize', 'mean': 'v. to combine disparate parts into a coherent whole'},
//   {'id': 334, 'name': 'tacit', 'mean': 'adj. unspoken; implicit'},
//   {'id': 335, 'name': 'taciturn', 'mean': 'adj. reticent or reserved; tending towards silence'},
//   {'id': 336, 'name': 'temperance', 'mean': 'n. moderation and restraint, sometimes used to specifically describe abstinence from alcohol'},
...
//   {'id': 342, 'name': 'tractable', 'mean': 'adj. can be easily influenced or managed'},
//   {'id': 343, 'name': 'transient', 'mean': 'adj. passes quickly; short-lived'},
...
//   {'id': 348, 'name': 'untenable', 'mean': 'adj. weak or unsupportable, esp. with respect to an opinion or situation'},
//   {'id': 349, 'name': 'vacillate', 'mean': 'v. to shift between multiple options or opinions'},
//   {'id': 350, 'name': 'venality', 'mean': 'n. the state of being capable of being bribed'},
//   {'id': 351, 'name': 'venerate', 'mean': 'v. to give a high degree of respect; may border on worship'},
//   {'id': 352, 'name': 'veracity', 'mean': 'n. Truth and factual accuracy'},
//   {'id': 353, 'name': 'verbose', 'mean': 'adj. long-winded; loquacious'},
//   {'id': 354, 'name': 'vexation', 'mean': 'n. state of being frustrated, irritated, or concerned.'},
//   {'id': 355, 'name': 'volatile', 'mean': 'adj. easily changeable or extreme; unstable'},
