...
class _WordDetailsState extends State<WordDetails> {
  ...
  void getAllFav() async {
    ...
    if (result.isEmpty) {
      ...
      results = await dbFavourite.queryAll();
    }
    setState(() {
      result = results;
    });
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: ListTile(
                  title:
                    widget.description!.isNotEmpty //DESCRIPTION
                        ? RichText(
                      text: TextSpan(
              ...
              Column(
                children: [
                  ...
                  //     });
                  //   }else {
                  //       await dbFavourite.delete(0); // DOES NOT WORK
                  //       setState(() {
                  //         isPressed = false;
                  //       });
                  //     }
